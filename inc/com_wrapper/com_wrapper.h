...
typedef void* (*COM_WRAPPER_MALLOC_FUNCTION)(size_t size);
typedef void (*COM_WRAPPER_FREE_FUNCTION)(void* ptr);
...
/* Codes_SRS_COM_WRAPPER_66_003: [ DEFINE_COM_WRAPPER_OBJECT_WITH_MALLOC_FUNCTIONS shall use malloc_func to allocate the COM wrapper object memory. ]*/
#define IMPLEMENT_COM_WRAPPER_TYPE_CREATE_COMMON_WITH_MALLOC_FUNCTIONS(wrapped_handle_type, malloc_func, free_func, ...) \
    ...
    { \
        MU_C2(wrapped_handle_type, _COM_WRAPPER)* result = (MU_C2(wrapped_handle_type, _COM_WRAPPER)*)malloc_func(sizeof(MU_C2(wrapped_handle_type, _COM_WRAPPER))); \
        if (result == NULL) \
        { \
        ...
        { \
            ...
            result->malloc_func = (COM_WRAPPER_MALLOC_FUNCTION)(malloc_func); \
            result->free_func = (COM_WRAPPER_FREE_FUNCTION)(free_func); \
...
#define IMPLEMENT_COM_WRAPPER_TYPE_CREATE_COMMON(wrapped_handle_type, ...) \
    IMPLEMENT_COM_WRAPPER_TYPE_CREATE_COMMON_WITH_MALLOC_FUNCTIONS(wrapped_handle_type, malloc, free, __VA_ARGS__)
...
#define TYPEDEF_COM_WRAPPER_OBJECT(wrapped_handle_type, ...) \
    ...
    { \
        ...
        COM_WRAPPER_MALLOC_FUNCTION malloc_func; \
        COM_WRAPPER_FREE_FUNCTION free_func; \
...
/* Codes_SRS_COM_WRAPPER_66_004: [ DEFINE_COM_WRAPPER_OBJECT_WITH_MALLOC_FUNCTIONS shall use free_func to free the COM wrapper memory. ]*/
...
{ \
    ...
    { \
        ...
        { \
            ...
            com_wrapper->free_func(com_wrapper); \
        } \
    } \
    return result; \
} \
...
/* Codes_SRS_COM_WRAPPER_66_001: [ DEFINE_COM_WRAPPER_OBJECT_WITH_MALLOC_FUNCTIONS shall generate constructors for the COM object for each implemented interface. ]*/
/* Codes_SRS_COM_WRAPPER_66_002: [ DEFINE_COM_WRAPPER_OBJECT_WITH_MALLOC_FUNCTIONS shall generate all the underlying Vtbl structures needed for the COM object. ]*/
...
#define DEFINE_COM_WRAPPER_OBJECT(wrapped_handle_type, ...) \
    DEFINE_COM_WRAPPER_OBJECT_WITH_MALLOC_FUNCTIONS(wrapped_handle_type, malloc, free, __VA_ARGS__)
